...
import { User, Menu, X, Code, MessageCircle, Lightbulb, Route, LinkIcon } from 'lucide-react';
const Navbar = () => {
          ...
          <div className="hidden md:block">
            ...
            <NavLink
              ...
              <NavLink
                ...
                className="text-white hover:bg-purple-700 px-3 py-2 rounded-md text-sm font-medium transition duration-300"
              >
                <span title='links'><LinkIcon className="h-5 w-5" /></span>
              </NavLink>
              <NavLink
                to="/coding"
                className="text-white hover:bg-purple-700 px-3 py-2 rounded-md text-sm font-medium transition duration-300"
              ...
              <NavLink
                ...
                className="text-white hover:bg-purple-700 px-3 py-2 rounded-md text-sm font-medium transition duration-300"
              >
                <span title='Discuss'><MessageCircle className='h-6 w-6'/></span>
              </NavLink>
              {token && (
                <NavLink
                  to="/profile"
        ...
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <NavLink
              ...
              onClick={toggleMenu}
            >
              <LinkIcon className="h-5 w-5 inline-block" /> Path
            </NavLink>
            <NavLink
              to="/coding"
              className="text-white block hover:bg-purple-700 px-3 py-2 rounded-md text-base font-medium transition duration-300"
            ...
            <NavLink
              ...
              onClick={toggleMenu}
            >
              <MessageCircle className="h-5 w-5 inline-block" /> Discuss
            </NavLink>
            {token && (
              <NavLink
                to="/profile"
